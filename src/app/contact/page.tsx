...
export const metadata: Metadata = {
  ...
  description:
    'Contact ILKKA Healthcare for medical equipment inquiries, support, and partnership opportunities. Serving Ethiopia and Somaliland with quality healthcare solutions.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Get in touch with ILKKA Healthcare for medical equipment inquiries, support, and partnership opportunities across Ethiopia and Somaliland.',
...
export default function ContactPage() {
  const jsonLd = {
    ...
    description:
      'Contact information and form for ILKKA Healthcare medical equipment supplier',
    url: 'https://ilkka-healthcare.com/contact',
    mainEntity: {
      '@type': 'Organization',
          ...
          <div className="container mx-auto px-4 py-8">
            <header className="mb-12 text-center">
              ...
              <p className="text-muted-foreground mx-auto max-w-3xl text-lg">
                Get in touch with our healthcare experts for inquiries about
                medical equipment, support services, or partnership
                opportunities.
              </p>
            </header>
          </div>
