...
export const metadata: Metadata = {
  title:
    'Medical Products & Equipment - Blood Pressure Monitors, Healthcare Supplies',
  description:
    "Explore ILKKA Healthcare's comprehensive range of medical equipment including blood pressure monitors, diagnostic tools, patient monitoring devices, and healthcare supplies for Ethiopia and Somaliland.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Comprehensive range of medical equipment and healthcare supplies. Quality blood pressure monitors, diagnostic tools, and patient monitoring devices.',
...
export default function ProductsPage() {
  const jsonLd = {
    ...
    description:
      'Comprehensive range of medical equipment and healthcare supplies from ILKKA Healthcare',
    url: 'https://ilkka-healthcare.com/products',
    mainEntity: {
      '@type': 'ItemList',
          ...
          <div className="container mx-auto px-4 py-8">
            <header className="mb-12 text-center">
              ...
              <p className="text-muted-foreground mx-auto max-w-3xl text-lg">
                Discover our comprehensive range of medical equipment and
                healthcare supplies, trusted by professionals across Ethiopia
                and Somaliland.
              </p>
            </header>
          </div>
