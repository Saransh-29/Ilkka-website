...
export const metadata: Metadata = {
  ...
  description:
    'Ilkka Healthcare provides premium medical equipment, blood pressure monitors, and healthcare supplies in Ethiopia and Somaliland. Trusted by healthcare professionals.',
  openGraph: {
    title: 'Ilkka Healthcare - Medical Equipment & Healthcare Solutions',
    description:
      'Premium medical equipment and healthcare supplies in Ethiopia and Somaliland. Trusted by healthcare professionals.',
